# Functional Python [![](https://github.com/zealotwithcharge/functional-python/workflows/tests/badge.svg)](https://github.com/zealotwithcharge/functional-python/actions?query=workflow%3Atests)
